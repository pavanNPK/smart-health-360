    ...
    children: [
      {
        ...
        children: [
          ...
          { path: 'patients/:id', loadComponent: () => import('./features/patient-details/patient-details').then((m) => m.PatientDetails) },
          { path: 'patients/:id/details', loadComponent: () => import('./features/patient-details/patient-details').then((m) => m.PatientDetails) },
          { path: 'patients/:id/import', loadComponent: () => import('./features/patient-import/patient-import').then((m) => m.PatientImport) },
          { path: 'audit', loadComponent: () => import('./features/audit-viewer/audit-viewer').then((m) => m.AuditViewer) },
        ],
      },
      {
        path: 'doctor',
